...
//! Driver for Infineon's CYW4343x WiFi chips
...
pub mod firmware {
    ...
    pub const CYW43439_BLOBS: CYW4343xBlobs = CYW4343xBlobs {
        fw: cyw43::cyw43439::FW,
        nvram: cyw43::cyw43439::NVRAM,
        clm: cyw43::cyw43439::CLM,
    };

    /// CYW4343x firmware blobs
    pub struct CYW4343xBlobs {
        pub fw: &'static [u8],
        pub nvram: &'static [u8],
        pub clm: &'static [u8],
    }
