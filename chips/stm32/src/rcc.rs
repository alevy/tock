...
pub enum SystemClockSource {
    InternalOscillator,
    ExternalOscillator { frequency: OscillatorFrequency },
...
impl ResetClockControl {
    ...
    pub unsafe fn setup_system_clock(&self, clock_source: SystemClockSource) {
        ...
        match clock_source {
            ...
            SystemClockSource::ExternalOscillator { frequency } => {
                configure_external_oscillator(frequency);
                match frequency {
                    OscillatorFrequency::Frequency8MHz => self.system_frequency.set(8000000),
                };
            }
...
unsafe fn configure_external_oscillator_pll(frequency: OscillatorFrequency) {
    ...
    regs.cfgr.set((regs.cfgr.get() & !(0xf << 18)) | (0b0111 << 18) | (1 << 16)); // PLL x9 | PLLSRC
