...
unsafe extern "C" fn hard_fault_handler() {
    ...
    if kernel_stack {
        ...
        let shcsr: u32 = read_volatile(0xE000ED24 as *const u32);
        let cfsr: u32 = read_volatile(0xE000ED28 as *const u32);
        let hfsr: u32 = read_volatile(0xE000ED2C as *const u32);
        let mmfar: u32 = read_volatile(0xE000ED34 as *const u32);
        let bfar: u32 = read_volatile(0xE000ED38 as *const u32);
